...
import { Sensor, getSensors } from '@/entities/sensor';
import { User, getUsers } from '@/entities/user';
import { SensorsTab } from '@/widgets/sensors-tab';
import { MeasurementsTab } from '@/widgets/measurements-tab';
import { UsersTab } from '@/widgets/users-tab';
